CREATE TABLE IF NOT EXISTS test_aux AS SELECT
id,
block29,
...
FROM test;
CREATE INDEX IF NOT EXISTS test_aux_id ON test_aux ( id );
CREATE INDEX IF NOT EXISTS test_aux_blk ON test_aux ( block29 );
CREATE INDEX IF NOT EXISTS test_aux_adlt ON test_aux ( aux_srch_adults_cnt );
CREATE INDEX IF NOT EXISTS test_aux_chld ON test_aux ( aux_srch_children_cnt );
CREATE INDEX IF NOT EXISTS test_aux_rm ON test_aux ( aux_srch_rm_cnt );
CREATE INDEX IF NOT EXISTS test_aux_dur ON test_aux ( aux_duration );
CREATE INDEX IF NOT EXISTS test_aux_cidw ON test_aux ( aux_ci_dow );
CREATE INDEX IF NOT EXISTS test_aux_codw ON test_aux ( aux_co_dow );
CREATE INDEX IF NOT EXISTS test_aux_sdw ON test_aux ( aux_srch_dow );
CREATE INDEX IF NOT EXISTS test_aux_we ON test_aux ( aux_weekend );
CREATE INDEX IF NOT EXISTS test_aux_cise ON test_aux ( aux_ci_season );
CREATE INDEX IF NOT EXISTS test_aux_std ON test_aux ( aux_srch_tod );
CREATE INDEX IF NOT EXISTS test_aux_dist ON test_aux ( aux_dist );
